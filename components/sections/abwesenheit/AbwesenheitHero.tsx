...
export default function AbwesenheitHero() {
  return (
    <section
      className="py-16 lg:py-20 px-8"
      style={{ backgroundColor: 'rgba(0, 120, 158, 0.4)' }}
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div
              ...
              style={{ borderColor: 'var(--color-abwesenheit-secondary)' }}
            >
              <Image
                src="/images/produkte/AVA_ABWESENHEIT_DE (1).webp"
                alt="Abwesenheitsverwaltung für NetSuite"
                width={400}
                height={400}
