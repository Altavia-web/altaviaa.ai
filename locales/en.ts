export const en = {
  ...
  home: {
    hero: {
      title: 'Is your NetSuite system ready for Germany?',
      subtitle: 'Alta Via Applications is your compass to the highest peaks of NetSuite. Download brochure: A Compact Overview and Decision-Making Aid.',
    ...
    partners: {
      heading: 'For NetSuite Users and Partners – Climbing to the Top Together',
      users: {
        title: 'For NetSuite Users',
        paragraph: 'Shorter release cycles, practical functionality, and a clear product strategy make our solutions a reliable companion – whether for localization, DATEV interfaces, or specialized tools such as dunning, travel expenses, and shipping processing.',
      },
      partners: {
        title: 'For NetSuite Partners',
        paragraph: 'As a pure product provider, Alta Via Applications does not offer consulting or implementation services – we complement your solution without competing with you.',
      },
      altImage: 'Signpost Icon',
    },
    testimonial: {
      quote: 'We do not compete with partners – on the contrary: we complement your offering with ready-to-use, field-tested NetSuite extensions.',
  ...
  footer: {
    ...
    description: 'Take advantage of our partner program—including sales materials, trial access, and direct contact.',
    cta: 'Arrange a demo: sales@altaviaa.ai',
